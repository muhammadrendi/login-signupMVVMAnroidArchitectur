...
import com.example.loginsignupmvvm.AuthActivity
import com.example.loginsignupmvvm.data.UserPreferences
import com.example.loginsignupmvvm.data.network.RemoteDataSource
...
abstract  class BaseFragments<VM: BaseViewModel, B:ViewBinding, R:BaseRepository> : Fragment() {
